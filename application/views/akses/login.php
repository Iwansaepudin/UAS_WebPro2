...
<center><img src="<?= base_url('assets/images/logo.png') ?>" style="max-width:30%;" type="image/x-icon"></center>

<body class="login-page">
	<div class="login-box">
		<div class="logo">
			<a href="javascript:void(0);"><b>Za</b> <b>Laundry</b></a>
			<small>Laundrynya STMIK Antar Bangsa</small>
		</div>
		<div class="card">
			<div class="body">
				...
				<br>
				<center>
					<p>Powered by <a href="javascript:void(0);" title="STMIK Antar Bangsa" target="_blank">STMIK Antar Bangsa</a></p>
				</center>
			</div>
		</div>
	</div>
