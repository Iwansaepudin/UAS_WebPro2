...
<body class="theme-purple">
	...
	<nav class="navbar">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="<?= site_url('beranda/p/beranda') ?>" style="text-transform: uppercase;">Sistem Manajemen Za Laundry</a>
			</div>
		</div>
	</nav>
	<!-- #Top Bar -->
	<section>
		...
		<aside id="leftsidebar" class="sidebar">
			...
			<div class="legal">
				<div class="copyright">
					<center>&copy; 2023 <a href="javascript:void(0);">ZA - Laundry</a>.
					</center>
					<br>
					<center>
