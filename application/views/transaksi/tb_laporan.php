    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="body">
				...
				<div class="head">
					<h2>laporan transaksi Za Laundry</h2>
					<h2>jl. raya Tangerang</h2>
					<p style="font-weight: normal;text-transform: capitalize;">No Telepon : (025) XXX-XXX-XXX Email : <span style="text-transform: none;">zalaundry@gmail.com</span> no Handphone : 089-XXX-XXX-XXX</p>
				...
				<div class="row clearfix">
					<div class="ttd">
						...
						<p>Pimpinan</p>
						<br><br><br>
						<p style="font-weight: bold;">Ibnu</p>
					</div>
				</div>
            </div>
        </div>
